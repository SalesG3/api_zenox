...
async function relatorio_contas_pagar(req){
    ...
    let [rows] = await con.promise().query(`
        ...
        WHERE F.ID_ENTIDADE = ? AND F.TP_FINANCEIRO = 'D'
            ...
            columns: [
                ...
                },
                {
                    stack: [
                        ...
                        { text: "Contas a Pagar - Por Credor", fontSize: 14, bold: true, margin: [20, 10, 20, 5], color: 'red'}
